...
test_that("example_model adl?? de??i??ken bulunmakta", {
  expect_true(exists("example_model"))
})

#12


test_that("predictions_list adl?? de??i??ken bulunmakta", {
  expect_true(exists("predictions_list"))
})
...
test_that("prediction_table_all adl?? de??i??ken bulunmakta", {
  expect_true(exists("prediction_table_all"))
})
